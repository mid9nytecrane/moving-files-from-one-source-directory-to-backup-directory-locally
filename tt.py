       ...
       # print(src_status.st_size)
        ...
        if file.endswith(".txt"):
            ...
            if not os.path.exists(textfolder_path): #if the folder does not exist
                ...
                print(f"{file} moved to {textfolder_path}")
            else:
                if file not in textfolder_path_list: #when file is not  the folder created
                    ...
                    print(f"{file} copied to {textfolder_path} @ {now}") #print out the file name and the timestamp
                else:
                    #os.replace(fil_path,textfile_path)
                    print(f"\t{file} exist already skip...")

        elif file.endswith(".png") or file.endswith(".jpg") or file.endswith(".JPG") or file.endswith(".svg") or file.endswith(".gif"):  #checks if the file is an image file
            ...
            if not os.path.exists(imagefolder_path):
                ...
                print(f"{file} copied to {imagefolder_path} @ {now}")
            else:
            ...
            if not os.path.exists(pdffolder_path):
                ...
                print(f"{file} copied to {pdffolder_path} @ {now}")
            else:
            ...
            if not os.path.exists(audiofolder_path):
                ...
                print(f"{file} copied to {audiofolder_path} @ {now}")
            else:
